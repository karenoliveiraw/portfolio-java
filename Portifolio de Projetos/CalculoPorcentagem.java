...
public class CalculoPorcentagem extends JDialog {
	...
	public CalculoPorcentagem() {
		...
		RestrictedTextField validarY = new RestrictedTextField(txtY, "0123456789.");
		RestrictedTextField validarX = new RestrictedTextField(txtX, "0123456789.");
		RestrictedTextField validarDesconto = new RestrictedTextField(txtDesconto, "0123456789.");
		RestrictedTextField validarSub = new RestrictedTextField(txtSub, "0123456789.");
		RestrictedTextField validarCusto = new RestrictedTextField(txtCusto, "0123456789.");
		RestrictedTextField validarLucro = new RestrictedTextField(txtLucro, "0123456789.");
