...
public class Juros extends JDialog {
	 ...
	 */
	public Juros() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Juros.class.getResource("/img/3702385_back_cash_money_icon (1).png")));
		...
		// * Uso do atxy2k para validação
				RestrictedTextField validarAplicacao = new RestrictedTextField(txtAplicacao, "0123456789.");
				RestrictedTextField validarPeriodo = new RestrictedTextField(txtPeriodo, "0123456789.");
				RestrictedTextField validarTaxa = new RestrictedTextField(txtTaxa, "0123456789.");
	...
	void calcular() {
		...
		// saida
		txtJuros.setText(String.valueOf(formatador.format(juros)));
