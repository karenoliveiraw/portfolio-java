...
public class Media extends JDialog {
	...
	public Media() {
		...
		RestrictedTextField validarNota1 = new RestrictedTextField(txtNota1, "0123456789.");
		RestrictedTextField validarNota2 = new RestrictedTextField(txtNota2, "0123456789.");
		RestrictedTextField validarNota3 = new RestrictedTextField(txtNota3, "0123456789.");
		RestrictedTextField validarNota4 = new RestrictedTextField(txtNota4, "0123456789.");
		validarNome.setOnlyText(true);
		validarNome.setAcceptSpace(true);

		validarDisciplina.setOnlyText(true);
		validarDisciplina.setAcceptSpace(true);
