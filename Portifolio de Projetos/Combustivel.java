...
public class Combustivel extends JDialog {
	...
	public Combustivel() {
		...
		}
		{
			...
			btnNewButton.setIcon(new ImageIcon(Combustivel.class.getResource("/img/gasoline_oil_gas_fuel_pump_icon_150429.png")));
		...
		RestrictedTextField validarGasolina = new RestrictedTextField(txtGasolina, "0123456789.");
	
		validarGasolina.setLimit(5);
		RestrictedTextField validarEtanol = new RestrictedTextField(txtEtanol, "0123456789.");
